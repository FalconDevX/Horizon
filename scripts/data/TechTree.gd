...
const NODES := [
	...
	{"id": &"floor", "title": "Floor", "branch": Branch.STRUCTURE, "tier": 1,
		"recipe": [&"scrap", &"silver_ore"], "requires": [], "modules": [&"floor_1", &"floor_2", &"floor_3"],
	...
	{"id": &"scanner", "title": "Surface Scanner", "branch": Branch.SUPPORT, "tier": 1,
		"recipe": [&"gold_ore", &"pink_crystal"], "requires": [], "modules": [&"util_scanner"]},
	{"id": &"repair", "title": "Repair Module", "branch": Branch.SUPPORT, "tier": 2,
		"recipe": [&"gold_ore", &"sky_stone", &"bone"], "requires": [&"scanner"], "modules": [&"util_repair"],

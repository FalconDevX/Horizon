...
## the node's recipe (PlayerProgress spends it). The `requires` links are not
...
const NODES := [
	...
	{"id": &"hull_light", "title": "Light Hull", "branch": Branch.STRUCTURE, "tier": 1,
		"recipe": [&"aluminium"], "requires": [], "modules": [&"hull_light"]},
	{"id": &"floor", "title": "Floor", "branch": Branch.STRUCTURE, "tier": 1,
		"recipe": [&"iron", &"aluminium"], "requires": [], "modules": [&"floor_1", &"floor_2", &"floor_3"],
		"note": "Extends a ship: deck tiles that attach straight to a hull."},
	{"id": &"truss", "title": "Truss", "branch": Branch.STRUCTURE, "tier": 1,
		"recipe": [&"aluminium"], "requires": [], "modules": [&"truss_1", &"truss_2", &"truss_3"],
	...
	{"id": &"engine_nuclear", "title": "Nuclear Thermal Engine", "branch": Branch.PROPULSION, "tier": 3,
		"recipe": [&"iron", &"xenon", &"uranium"], "requires": [&"engine_plasma"],
	...
	{"id": &"fuel_tank", "title": "Fuel Tank", "branch": Branch.POWER, "tier": 1,
		"recipe": [&"iron", &"aluminium"], "requires": [],
	...
	{"id": &"sonar", "title": "Sonar / Radar", "branch": Branch.SUPPORT, "tier": 1,
		"recipe": [&"copper", &"silicon", &"xenon"], "requires": [],
		"modules": [&"radar_proximity", &"radar_survey", &"radar_deep"],
		"note": "Detects nearby enemies."},
	{"id": &"scanner", "title": "Surface Scanner", "branch": Branch.SUPPORT, "tier": 1,
		"recipe": [&"copper", &"silicon"], "requires": [], "modules": [&"util_scanner"]},
	{"id": &"repair", "title": "Repair Module", "branch": Branch.SUPPORT, "tier": 2,
		"recipe": [&"copper", &"nickel", &"titanium"], "requires": [&"scanner"], "modules": [&"util_repair"],
		"note": "Repairs neighbouring modules; power hungry, can be switched off."},
	{"id": &"shields", "title": "Shields", "branch": Branch.SUPPORT, "tier": 2,
		"recipe": [&"copper", &"lithium"], "requires": [&"generator"],
	...
	{"id": &"fabricator", "title": "Fabricator", "branch": Branch.SUPPORT, "tier": 2,
		"recipe": [&"iron", &"copper", &"silicon"], "requires": [&"repair"], "modules": [&"util_fabricator"],
